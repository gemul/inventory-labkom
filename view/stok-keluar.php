                        ...
                        <div class='panel-footer'>
                          <div class='row'>
                            <div class='col-lg-3'>
                              ...
                              <script type=text/javascript>
                              function paging(e){
                                window.location='?a=view-stok-keluar&pg='+e.value+"<?php if(isset($_GET['s']))echo "&s=".$_GET['s'];?><?php if(isset($_GET['f']))echo "&f=".$_GET['f'];?>";
                              }
                              </script>
                            </div>
                            <div class='col-lg-4'>
                              ...
                              function sortTable(e){
                                window.location='?a=view-stok-keluar&s='+e.value+"<?php if(isset($_GET['f']))echo "&f=".$_GET['f'];?>";
                              }
                              </script>
                            </div>
                            <div class='col-lg-4'>
