<?php
  include('../lib/phpbarcode/php-barcode.php');
  ...
  $font     = '../lib/phpbarcode/font/NOTTB___.TTF';
  // - -
  
  $fontSize = 11;   // GD1 in px ; GD2 in point
  ...
  if(empty($_GET['c'])){
	  ...
	  $bcd=substr($_GET['c'],0,12);
  }
  $code     = $bcd; // barcode, of course ;)
  $type     = 'ean13';
  ...
  // -------------------------------------------------- //
  $im     = imagecreatetruecolor(210, 50);
  $black  = ImageColorAllocate($im,0x00,0x00,0x00);
  $white  = ImageColorAllocate($im,0xff,0xff,0xff);
  $red    = ImageColorAllocate($im,0xff,0x00,0x00);
  $blue   = ImageColorAllocate($im,0x00,0x00,0xff);
  imagefilledrectangle($im, 0, 0, 210, 50, $white);
